...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            <!--begin::Page Title-->
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Quản lý môn học</h5>
            <!--end::Page Title-->
        </div>
        <!--end::Info-->
    </div>
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                <div class="card-title">
                    <h3 class="card-label">Danh sách môn học
                        <span class="d-block text-muted pt-2 font-size-sm">Danh sách các môn học có trên hệ
                            thống</span>
                    </h3>
                </div>
                <?php if ($data['checkPermission']['add']) : ?>
                    <div class="card-toolbar">
                        <!--begin::Button-->
                        <a href="<?= $config['baseUrl'] ?>?role=admin&mod=subject&action=create" class="btn btn-primary font-weight-bolder">
