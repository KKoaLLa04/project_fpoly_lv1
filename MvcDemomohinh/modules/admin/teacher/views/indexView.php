<?php get_header('', 'Giảng viên coi thi') ?>
...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            <!--begin::Page Title-->
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Giảng viên coi thi</h5>
            <!--end::Page Title-->
        </div>
        <!--end::Info-->
    </div>
        ...
        <div class="card card-custom">
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                <div class="card-title">
                    <h3 class="card-label">Giảng viên coi thi
                        <span class="d-block text-muted pt-2 font-size-sm">Giảng viên coi thi</span>
                    </h3>
                </div>
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="<?= $config['baseUrl'] ?>?role=admin&mod=teacher&action=create"
                        ...
                        <span class="svg-icon svg-icon-md">
                            ...
                            <!--end::Svg Icon-->
                            <!-- </span>Thêm lịch thi của giảng viên</a> -->
                            <!--end::Button-->
                </div>
            </div>
            <div class="card-body">
                ...
                <table class="datatable datatable-bordered datatable-head-custom" id="kt_datatable">
                    <thead>
                        <tr>
                            ...
                            <th title="Field #2">Học kỳ</th>
                            <th title="Field #3">Môn thi</th>
                            <th title="Field #4">Lớp thi</th>
                            <th title="Field #5">Môn thi</th>
                            <th title="Field #6">Giảng viên coi thi</th>
                    ...
                    <tbody>
                        <?php if (!empty($data['teacher'])) :
                            ...
                            echo '</pre>';
                            foreach ($data['teacher'] as $key => $subject) : ?>
                        <tr>
                            <td><?= $key + 1 ?></td>
