            ...
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                <div class="card-title">
                    <h3 class="card-label">Danh sách danh mục sản phẩm
                        <span class="d-block text-muted pt-2 font-size-sm">Danh sách các danh mục sản phẩm có trên hệ
                            thống</span>
                    </h3>
                </div>
                <div class="card-toolbar">
                    <!--begin::Button-->
                    <a href="<?= $config['baseUrl'] ?>?role=admin&mod=category&action=create"
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="overflow: visible; position: relative; width: 125px;">
                                    <a href="<?= $config['baseUrl'] ?>?role=admin&mod=category&action=update&id_cate="
                                    ...
                                    <a href="<?= $config['baseUrl'] ?>?role=admin&mod=category&action=delete&id_cate="
                                        onclick="return confirm('Bạn chắc chắn muốn xoá danh mục: <?php echo $category['name'] ?> không? Hành động sẽ xoá danh mục và toàn bộ sản phẩm có trong danh mục này.')"
