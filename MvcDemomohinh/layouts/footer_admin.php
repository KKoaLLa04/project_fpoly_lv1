    ...
    <div class="offcanvas-content pr-5 mr-n5">
        ...
        <div class="d-flex align-items-center mt-5">
            ...
            <div class="d-flex flex-column">
                <a href=""
                    class="font-weight-bold font-size-h5 text-dark-75 text-hover-primary"><?=$_SESSION['login_information']['name']?></a>
                ...
                <div class="navi mt-2">
                    <a href="#" class="navi-item">
                        <span class="navi-link p-0 pb-2">
                            ...
                            <span
                                class="navi-text text-muted text-hover-primary"><?=$_SESSION['login_information']['email']?></span>
                        </span>
                    </a>
                    <a href="?role=client&mod=login&action=signout"
        ...
        <div class="navi navi-spacer-x-0 p-0">
            <!--begin::Item-->
            <a href="?role=admin&mod=profile" class="navi-item">
                <div class="navi-link">
            ...
            <!--end:Item-->
            <!--begin::Item-->
            <a href="?role=admin&mod=profile&action=changePass" class="navi-item">
                <div class="navi-link">
                    <div class="symbol symbol-40 bg-light mr-3">
                        <div class="symbol-label">
                            <i class="fa fa-solid fa-key" style="color: #ffd43b;"></i>
                        </div>
                    </div>
                    <div class="navi-text">
