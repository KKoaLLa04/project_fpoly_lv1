            ...
            <div class="aside-menu-wrapper flex-column-fluid" id="kt_aside_menu_wrapper">
                ...
                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item" aria-haspopup="true">
                            <a href="<?= $config['baseUrl'] ?>?role=admin&mod=exam_media" class="menu-link">
                                <span class="svg-icon menu-icon">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-left-panel-2.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <span class="menu-text">Phát đề thi*</span>
                            </a>
                        </li>
                    ...
                    <div class="topbar">
                        ...
                        <div class="topbar-item">
                            <div class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                                ...
                                <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3">Nguyễn
                                    Văn A</span>
