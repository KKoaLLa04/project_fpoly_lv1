    ...
    <div class="d-flex flex-row flex-column-fluid page">
        ...
        <div class="aside aside-left aside-fixed d-flex flex-column flex-row-auto" id="kt_aside">
            ...
            <div class="brand flex-column-auto" id="kt_brand">
                <!--begin::Logo-->
                <a href="<?= $config['baseUrl'] ?>" class="brand-logo" style="font-size: 24px; color: white; font-weight: 500;">
                    <!-- <img alt="Logo" src="assets/media/logos/logo-light.png" /> -->
                    <span>FPTShop</span>
                </a>
                <!--end::Logo-->
                ...
                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1" data-menu-dropdown-timeout="500">
                    ...
                    <ul class="menu-nav">
                        <li class="menu-item menu-item-active" aria-haspopup="true">
                            <a href="<?= $config['baseUrl'] ?>?role=admin" class="menu-link">
                        ...
                        <li class="menu-item" aria-haspopup="true">
                            <a href="<?= $config['baseUrl'] ?>?role=admin&mod=examination_history" class="menu-link">
                                <span class="svg-icon menu-icon">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-left-panel-2.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink" width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                                        <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
                                ...
                                <span class="menu-text">Lịch sử tải đề</span>
                            </a>
                        </li>
                ...
                <div class="container-fluid d-flex align-items-stretch justify-content-between">
                    ...
                    <div class="topbar">
                        ...
                        <div class="topbar-item">
                            <a href="" class="btn btn-icon w-auto btn-clean d-flex align-items-center btn-lg px-2" id="kt_quick_user_toggle">
                                <span class="text-muted font-weight-bold font-size-base d-none d-md-inline mr-1">Hi,</span>
                                <span class="text-dark-50 font-weight-bolder font-size-base d-none d-md-inline mr-3"><?= $_SESSION['login_information']['name'] ?></span>
                                <span class="symbol symbol-35 symbol-light-success">
                                    <span class="symbol-label font-size-h5 font-weight-bold"><?= substr($_SESSION['login_information']['name'], 0, 1) ?></span>
                                </span>
                            </a>
                        </div>
                        <!--end::User-->
